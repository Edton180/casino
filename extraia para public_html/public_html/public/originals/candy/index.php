...
<head>
  ...
  <meta name='description'
    content='Candy Crush is a popular mobile puzzle game where players match colorful candies to progress through levels and earn points.'>
  ...
  <style>
    ...
    .destaque {
      animation: blink 2s infinite, shine 1s infinite;
...
<body onLoad="initGame()" style="background-image:url(../assets/images/candy-bg.png)">
  ...
  <div id="containerFormBet">
    <div id="containerContent">
      <div id="formBet">
        <label>Confirmar o valor da aposta</label>
