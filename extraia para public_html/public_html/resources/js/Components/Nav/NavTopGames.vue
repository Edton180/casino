<template>
    ...
    <nav class="fixed navbar z-45 w-full navtop-color border-none custom-box-shadow translucent-navbar"
         :style="{ top: showNewElement ? '0px' : '0' }">
                ...
                <div class="flex items-center justify-start py-3">
                    <a v-if="setting" href="/" class="flex ml-2 md:mr-24">
                        ...
                        <div class="block sm:hidden">
                            <img :src="`/storage/`+setting.software_logo_white" class="mt-2 h-6 mr-1" alt="" />
                        </div>
                    </a>
                </div>
...
<div class="flex items-center space-x-1"> <!-- Diminuiu o espaço entre os elementos -->
    <button class="ui-button-depositorapido" @click.prevent="toggleModalDeposit">
        Depósito Rápido
    </button>
...
<div  class="w-full  z-999 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 translucent-menu" id="dropdown-profile">
 ...
 <div  class="flex flex-col items-center justify-center w-full h-full border border-gray-300 custom-bg p-4 mt-2">
  ...
  <button v-if="wallet2" class="flex items-center justify-center w-full h-full border border-gray-300 rounded custom-bg p-2 mb-2" @click.prevent="togglePerfil">
  ...
  <div v-if="deposits && wallet" class="w-full mt-3">
  ...
  <div v-if="saq" class="mt-2 flex flex-col items-center justify-center w-full h-full border border-gray-300 rounded custom-bg p-2 mb-2">
  ...
  <div v-if="!historico" class="mt-2 flex flex-col items-center justify-center w-full h-full border border-gray-300 rounded custom-bg p-2 mb-2">
    <p class="text-white text-lg font-bold">Saldo da conta</p>
    <WalletMenu />
  </div>
  ...
  <div v-if="!historico && !wallet2" class="mt-2 flex flex-col items-center justify-center w-full h-full border border-gray-300  rounded custom-bg p-2 mb-2">
    <p class="text-white text-lg font-bold">Saldo de bônus</p>
    <WalletMenu2 />
  </div>
  ...
  <button v-if="!depositar && !historico" class="ui-button-custom-deposito mt-1" @click.prevent="toggleModalDeposit"> 
    ...
    <button v-if="depositar && wallet2 && !historico" class="ui-button-custom-deposito mt-1" @click="$router.push('/profile/withdraw')">
 ...
 <div v-if="!wallet2 && !historico" class="flex flex-col items-center justify-center w-full h-full border border-gray-300  custom-bg p-4 ">
    ...
    <!-- Retângulo de saldo da conta -->
  <button v-if="!wallet2 && !historico" class="flex items-center justify-center w-full h-full border border-gray-300 rounded custom-bg p-2 mb-1  mt-2" @click="$router.push('/events')">
    <i class="fa-duotone fa-gift mr-2"></i>
    <p class="text-white text-lg font-bold mr-2">Bônus</p>
    <span v-if="showBadge" class="rounded-full bg-red-700 text-white px-1 py-0.5 text-xs flex items-center justify-center" style="width: 18px; height: 18px; border: 1px solid #fff;">
            3
        </span>
  </button>
      ...
      <!-- Conteúdo do seu menu aqui -->
                            ...
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                                <ul class="py-1" role="none">
                                    ...
                                    <li>
  <button @click.prevent="toggleModalDeposit" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
...
import Esportes from "@/Components/UI/Esportes.vue";
...
export default {
    props: ['simple'],
    components: {CassinoGameCard, MakeDeposit2, WalletBalance, WalletMenu, WalletMenu2, LanguageSelector, DropdownDarkLight, RouterLink, Esportes, DepositWidget },
    data() {
        return {
            showNewElement: true,
                sumirmodal: false,
