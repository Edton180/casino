<template>
    <button @click.prevent="toggleModalDeposit" type="button" :class="[showMobile === false ? 'hidden md:block' : '', isFull ? 'w-full' : '']" >
<div class="flex items-center justify-center" @click.prevent="toggleModalDeposit">
    <div class="new-button-container">
        <div class="new-button-inner" @click.prevent="toggleModalDeposit">
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="icon icon-class text-black" width="1.1em" height="1.1em" viewBox="0 0 256 256" data-v-a8eacbc2="">
                <g fill="currentColor">
                    <path d="M184 96v106.31L173.32 186a20 20 0 0 0-36.9 14H56V96a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8" opacity=".2"></path>
            ...
            <div class="text-white text-center text-[12px] font-bold">Depositar</div>
        </div>
    </div>
</div>
    </button>
