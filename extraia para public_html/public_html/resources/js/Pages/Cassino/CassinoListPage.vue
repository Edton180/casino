<template>
    <BaseLayout>
        ...
        <div v-if="!isLoading" class="md:w-4/6 2xl:w-4/6 mx-auto">
            ...
            <img :src="`/storage/`+setting.software_bannerjogos" class="rounded bonus-icon w-full mt-2" alt="Bonus Icon"> <!-- Espaço ajustado abaixo da linha -->
...
<div class="grid grid-cols-3 gap-4 mb-5"> <!-- Alteração aqui para mostrar três jogos por linha -->
                            <CassinoGameCard
